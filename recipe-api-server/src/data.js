...
const data = [
  {
    ...
    picture: `${config.url}:${config.port}/assets/images/recipes/spaghetti.jpg`,
    procedure: 
...
5. Enjoy ;-)`,
...

  {
    ...
    picture: `${config.url}:${config.port}/assets/images/recipes/crock_pot_roast.jpg`,
    procedure: 
...
4. Cook on low for 7-9 hours.`,
...

  {
    ...
    picture: `${config.url}:${config.port}/assets/images/recipes/roasted_aspargus.jpg`,
    procedure: 
...
10. They are great plain, but sometimes I serve them with a light vinaigrette if we need something acidic to balance out our meal.`,
...

  {
    ...
    picture: `${config.url}:${config.port}/assets/images/recipes/oat_cookies.jpg`,
    procedure: 
...
10. About 6 1/2 dozen cookies.`,
...

  {
    ...
    picture: `${config.url}:${config.port}/assets/images/recipes/egg_fried_rice.jpg`,
    procedure: 
...
export function addNewRecipe(entry) {
  const newEntry = {
    id: getNextId(),
    ...entry
  };
...
export function editRecipe(id, entry) {
